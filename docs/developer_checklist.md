...
- [ ] **P0-001** Initialize Next.js 14 project with TypeScript **(S)** 
- [ ] **P0-002** Install and configure Tailwind CSS **(S)** → P0-001
...
- [ ] **P0-006** Create core data types **(M)** → P0-001
